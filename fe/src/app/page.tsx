...
export default function Home() {
  ...
  const [courseTab, setCourseTab] = useState<"courses" | "professors">(
    "courses"
  );
  ...
  const fetchPosts = async () => {
    try {
      const res = await fetch(
        `http://localhost:8000/posts/?category=${filterCategory}&user_id=${
          user?.id || ""
        }`
      );
  ...
  const getTagColor = (tag: string) => {
    const colors: any = {
      Freshman: "bg-blue-600",
      Sophomore: "bg-green-600",
      Junior: "bg-yellow-600",
      Senior: "bg-orange-600",
      Graduate: "bg-purple-600",
      PhD: "bg-pink-600",
      Alumni: "bg-red-600",
      "CS Major": "bg-indigo-600",
      "Business Major": "bg-teal-600",
      "Engineering Major": "bg-cyan-600",
      Meta: "bg-blue-500",
      Google: "bg-red-500",
      ...
      "Public Speaking": "bg-rose-600",
      Research: "bg-violet-600",
      Hackathons: "bg-fuchsia-600",
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:8000/connections/${parsedUser.id}`)
      ...
      .then((data) => {
        setConnections(data);
        setPendingRequests(
          data.filter((c: any) => c.status === "pending" && !c.is_sender)
        );
      })
      .catch((err) => console.error(err));
    ...
    setClubs([
      {
        ...
        category: "Academic",
        description:
          "Connect with fellow CS students and explore tech opportunities.",
        url: "https://instagram.com/sdsu_css",
      },
      {
        ...
        category: "Academic",
        description:
          "Network with business professionals and develop leadership skills.",
        url: "https://instagram.com/sdsuba",
      },
      {
        name: "Aztec Gaming",
        members: "180+",
        ...
        category: "Recreation",
        description: "Gaming community for all skill levels and platforms.",
        url: "https://www.instagram.com/aztecgamingsdsu/",
      },
      {
        ...
        category: "Academic",
        description:
          "Represent engineering students and organize professional events.",
        url: "https://instagram.com/sdsu_esc",
      },
      {
        ...
        category: "Recreation",
        description:
          "Fitness classes, intramural sports, and outdoor adventures.",
        url: "https://instagram.com/sdsurec",
      },
      {
        ...
        category: "Government",
        description:
          "Student government representing the voice of SDSU students.",
        url: "https://instagram.com/as_sdsu",
      },
      {
        name: "Aztec Dance Team",
        members: "45+",
        location: "Viejas Arena",
        category: "Arts",
        description:
          "Official dance team performing at athletic events and competitions.",
        url: "https://instagram.com/aztecdanceteam",
      },
      {
        ...
        category: "Academic",
        description:
          "Support pre-medical students with resources and networking.",
        url: "https://instagram.com/sdsupremed",
      },
      {
        name: "Aztec Marching Band",
        members: "200+",
        location: "Music Building",
        category: "Arts",
        description: "Perform at football games and represent SDSU with pride.",
        url: "https://instagram.com/aztecmarchingband",
      },
      {
        name: "Surf Club",
        members: "150+",
        ...
        category: "Recreation",
        description:
          "Catch waves and connect with fellow surfers in San Diego.",
        url: "https://instagram.com/sdsusurfclub",
      },
      {
        ...
        category: "Academic",
        description:
          "Professional development for accounting and finance students.",
        url: "https://instagram.com/sdsuaccounting",
      },
      {
        name: "Aztec Cheerleaders",
        members: "30+",
        location: "Viejas Arena",
        category: "Recreation",
        description: "Official cheerleading squad supporting Aztec athletics.",
        url: "https://instagram.com/azteccheer",
      },
      {
        ...
        category: "Academic",
        description: "Explore psychology careers and research opportunities.",
        url: "https://instagram.com/sdsupsychclub",
      },
      {
        ...
        category: "Social",
        description:
          "Join Greek life for leadership, service, and lifelong friendships.",
        url: "https://instagram.com/sdsufsl",
      },
      {
        name: "Aztec Nights",
        members: "800+",
        location: "Student Union",
        category: "Social",
        description: "Free weekend entertainment and activities for students.",
        url: "https://www.instagram.com/aztecnightssdsu/",
      },
      {
        ...
        category: "Cultural",
        description:
          "Support and community for international students at SDSU.",
        url: "https://instagram.com/sdsuisc",
      },
      {
        name: "Aztec Radio",
        members: "80+",
        ...
        category: "Media",
        description:
          "Student-run radio station broadcasting music and campus news.",
        url: "https://instagram.com/aztecradio",
      },
      {
        ...
        category: "Academic",
        description:
          "Professional organization for nursing students and career development.",
        url: "https://instagram.com/sdsunsa",
      },
      {
        ...
        category: "Recreation",
        description:
          "Hiking, camping, and outdoor activities throughout California.",
        url: "https://instagram.com/sdsuoutdooradventures",
      },
      {
        name: "MEChA",
        members: "120+",
        ...
        category: "Cultural",
        description:
          "Chicano/Latino student movement promoting education and culture.",
        url: "https://instagram.com/sdsu_mecha",
      },
      {
        name: "Sanskrit Club",
        members: "85+",
        ...
        category: "Cultural",
        description:
          "Celebrate Sanskrit language and Indian culture through events and activities.",
        url: "https://www.instagram.com/sanskritisdsu/",
      },
      {
        name: "APSA",
        members: "200+",
        ...
        category: "Cultural",
        description:
          "Asian Pacific Student Alliance promoting cultural awareness and community.",
        url: "https://www.instagram.com/apsasdsu/",
      },
      {
        name: "SDSU Research",
        members: "150+",
        ...
        category: "Academic",
        description:
          "Undergraduate research opportunities across all disciplines.",
        url: "https://www.instagram.com/sdsuresearch/",
      },
      {
        name: "SDSU International",
        members: "800+",
        location: "International Student Center",
        category: "Cultural",
        description:
          "Programs and support for international education and exchange.",
        url: "https://www.instagram.com/sdsu_international/",
      },
      {
        name: "Club Baseball",
        members: "40+",
        ...
        category: "Recreation",
        description:
          "Competitive club baseball team representing SDSU in tournaments.",
        url: "https://www.instagram.com/sdsuclubbaseball/",
      },
      {
        name: "AITP",
        members: "95+",
        ...
        category: "Academic",
        description:
          "Association of Information Technology Professionals for tech careers.",
        url: "https://www.instagram.com/sdsu_aitp/",
      },
      {
        name: "Aztec Womens Basketball",
        members: "15+",
        location: "Viejas Arena",
        category: "Recreation",
        description:
          "Official womens basketball team representing SDSU in NCAA competition.",
        url: "https://www.instagram.com/aztecwbb/",
      },
      {
        name: "Aztecs Rock Hunger",
        members: "300+",
        location: "Campus Wide",
        category: "Social",
        description:
          "Student organization fighting food insecurity and supporting community.",
        url: "https://www.instagram.com/aztecsrockhunger/",
      },
    ]);
  ...
  const searchCourseProfessors = async () => {
    try {
      ...
      if (selectedDept) params.append("department", selectedDept);
      const res = await fetch(
        `http://localhost:8000/professors/search?${params}`
      );
      const data = await res.json();
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:8000/users/recommended/${user.id}`)
      ...
      .then((data) => {
        let filtered = data;
        if (yearFilter)
          filtered = filtered.filter((u: any) => u.tags?.includes(yearFilter));
        if (majorFilter)
          filtered = filtered.filter((u: any) => u.tags?.includes(majorFilter));
        if (companyFilter)
          filtered = filtered.filter((u: any) =>
            u.tags?.includes(companyFilter)
          );
  ...
  const handleVote = async (postId: number, value: number) => {
    try {
      await fetch(
        `http://localhost:8000/posts/${postId}/vote?user_id=${user.id}&value=${value}`,
        {
          method: "POST",
        }
      );
  ...
  const handleAddComment = async (postId: number) => {
    ...
    try {
      await fetch(
        `http://localhost:8000/posts/${postId}/comments?content=${encodeURIComponent(
          content
        )}&user_id=${user.id}`,
        {
          method: "POST",
  ...
  const handleSearch = async () => {
    ...
    try {
      const res = await fetch(
        `http://localhost:8000/users/search?current_user_id=${user.id}&query=${searchQuery}`
      );
      const data = await res.json();
  ...
  const handleSendRequest = async (friendId: number) => {
    try {
      await fetch(
        `http://localhost:8000/connections/?user_id=${user.id}&friend_id=${friendId}`,
        {
          method: "POST",
        }
      );
  ...
  const handleAcceptRequest = async (connectionId: number) => {
    try {
      await fetch(
        `http://localhost:8000/connections/${connectionId}?status=accepted`,
        {
          method: "PUT",
        }
      );
  ...
  const confirmEventAction = () => {
    ...
    setRegisteredEvents((prev) => ({
      ...prev,
      [eventModal.eventName]: eventModal.action,
    }));
    setModal({
      isOpen: true,
      title: "Success",
      message: `Successfully ${eventModal.action.toLowerCase()}ed for ${
  ...
  const handleAddTag = async (tagId: number) => {
    try {
      await fetch(`http://localhost:8000/users/${user.id}/tags/${tagId}`, {
        method: "POST",
      });
    ...
    try {
      ...
      const url = profileData.newPassword
        ? `http://localhost:8000/users/${
            user.id
          }?old_password=${encodeURIComponent(profileData.oldPassword)}`
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <div
            className="w-32 h-32 border-4 border-t-transparent rounded-full animate-spin mx-auto"
      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-red-600 via-black to-red-800">
        <div className="text-center text-white px-6">
          ...
          <p className="text-xl mb-8 opacity-90">
            Connect with your SDSU community
          </p>
    ...
    <div className={`min-h-screen ${t.bg} flex`}>
      <div className={`w-64 ${t.sidebar} border-r ${t.border} p-6`}>
        ...
        <nav className="space-y-4">
          ...
          <button
            onClick={() => {
              setActiveSection("peer");
              localStorage.setItem("activeSection", "peer");
            }}
            className="w-full flex items-center gap-3 p-3 rounded-lg text-left"
            style={{
              backgroundColor:
          ...
          <button
            onClick={() => {
              ...
              localStorage.setItem("activeSection", "clubs");
            }}
            className="w-full flex items-center gap-3 p-3 rounded-lg text-left"
            style={{
              backgroundColor:
      ...
      <div className="flex-1 p-6 overflow-y-auto">
                ...
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      style={{
                        color: post.user_vote === 1 ? "#A6192E" : "#9CA3AF",
                      }}
                    >
                      <svg
                        className="w-6 h-6"
              ...
              {searchResults.length > 0 && (
                <div className="grid grid-cols-4 gap-4 mt-4">
                  {searchResults.map((result) => (
                    ...
                    >
                      <img
                        src={`https://ui-avatars.com/api/?name=${result.username}&size=300&background=random&color=fff&bold=true`}
                        alt={result.username}
                        ...
                        {result.tags && result.tags.length > 0 && (
                          <div className="flex flex-wrap gap-1 mb-3">
                            {result.tags.slice(0, 3).map((tag: string) => (
                              <span
                                key={tag}
                                className={`px-2 py-1 text-white text-xs rounded ${getTagColor(
                                  tag
                                )}`}
                              >
                                {tag}
        ...
        {activeSection === "events" && (
          <div className="space-y-4">
            {[
              {
                name: "Social Venture Challenge 2026",
                date: "October 1 – December 12, 2025 • 12:00 AM - 11:59 PM",
                location: "University Library",
                description:
                  "Apply to the Social Venture Challenge 2026! Zip Launchpad Calendar",
                action: "Register",
                tag: "Competition",
                color: "rgba(166, 25, 46, 0.2)",
              },
              {
                name: "Care and Custody: Past Responses to Mental Health",
                date: "October 20 – November 25, 2025 • 9:00 AM - 5:00 PM",
                location: "Love Library 2nd floor elevator lobby",
                description:
                  "Exhibition exploring historical responses to mental health care and custody.",
                action: "Join",
                tag: "Exhibition",
                color: "rgba(59, 130, 246, 0.2)",
              },
              {
                name: "Bryan Adams Concert",
                date: "Sunday, November 16, 2025 • 7:30 PM - 11:00 PM",
                location: "Viejas Arena",
                description:
                  "Bryan Adams live in concert at Viejas Arena. Tickets on sale now!",
                action: "Get Tickets",
                tag: "Concert",
                color: "rgba(236, 72, 153, 0.2)",
              },
              {
                name: "International Student Virtual Open Advising Hours",
                date: "Monday, November 17, 2025 • 10:00 AM - 11:30 AM",
                location: "Virtual",
                description:
                  "Open advising hours for international students via virtual platform.",
                action: "Join",
                tag: "Advising",
                color: "rgba(168, 85, 247, 0.2)",
              },
              {
                name: "GEO CoEng/CoS Getting Started Session",
                date: "Monday, November 17, 2025 • 10:00 AM - 11:00 AM",
                location: "SDSU Engineering Building E203-E",
                description:
                  "Global Education Office session for College of Engineering and Sciences students.",
                action: "Register",
                tag: "Academic",
                color: "rgba(59, 130, 246, 0.2)",
              },
              {
                name: "Queer Crafternoon",
                date: "Monday, November 17, 2025 • 12:00 PM - 1:00 PM",
                location: "The Pride Center Multipurpose Room",
                description:
                  "Creative crafting session hosted by the Pride Center.",
                action: "Join",
                tag: "Social",
                color: "rgba(245, 158, 11, 0.2)",
              },
              {
                name: "GEO CAL/COE Getting Started Session for Study Abroad",
                date: "Monday, November 17, 2025 • 3:00 PM - 4:00 PM",
                location: "Online virtual event",
                description:
                  "Study abroad information session for College of Arts and Letters and College of Education.",
                action: "Register",
                tag: "Study Abroad",
                color: "rgba(168, 85, 247, 0.2)",
              },
              {
                name: "Meet the Author: Thien Pham",
                date: "Monday, November 17, 2025 • 4:00 PM - 5:00 PM",
                location: "APIDA Center",
                description: "Author meet and greet event at the APIDA Center.",
                action: "Join",
                tag: "Literary",
                color: "rgba(245, 158, 11, 0.2)",
              },
              {
                name: "GraduAte",
                date: "Monday, November 17, 2025 • 4:30 PM - 5:30 PM",
                location: "The Pride Center Multipurpose Room",
                description:
                  "Graduate student support group at the Pride Center.",
                action: "Join",
                tag: "Graduate",
                color: "rgba(34, 197, 94, 0.2)",
              },
              {
                name: "Revision and Editing Strategies for Graduate Writers",
                date: "Monday, November 17, 2025 • 5:00 PM - 6:00 PM",
                location: "Zoom",
                description:
                  "Workshop on writing strategies for graduate students via Zoom.",
                action: "Register",
                tag: "Workshop",
                color: "rgba(166, 25, 46, 0.2)",
              },
              {
                name: "Fowler GEO Drop In Advising",
                date: "Tuesday, November 18, 2025 • 10:00 AM - 11:30 AM",
                location: "Lamden Hall Rm 419",
                description:
                  "Drop-in advising for Fowler College students interested in global education.",
                action: "Join",
                tag: "Advising",
                color: "rgba(168, 85, 247, 0.2)",
              },
              {
                name: "SDSU Student Symposium (S3) Information Session",
                date: "Tuesday, November 18, 2025 • 10:00 AM - 12:00 PM",
                location: "SDSU Imperial Valley Library",
                description:
                  "Information session about the Student Symposium. Free event.",
                action: "Register",
                tag: "Research",
                color: "rgba(59, 130, 246, 0.2)",
              },
              {
                name: "Free HIV Testing",
                date: "Tuesday, November 18, 2025 • 11:00 AM - 4:00 PM",
                location: "The Pride Center",
                description:
                  "Free HIV testing services provided at the Pride Center.",
                action: "Join",
                tag: "Health",
                color: "rgba(34, 197, 94, 0.2)",
              },
              {
                name: "Beyond Borders: International Student Employment Session",
                date: "Tuesday, November 18, 2025 • 12:00 PM - 2:00 PM",
                location: "Career Services SSE 1200",
                description:
                  "Employment guidance session for international students.",
                action: "Register",
                tag: "Career",
                color: "rgba(166, 25, 46, 0.2)",
              },
              {
                name: "Black Womens Healing Circle",
                date: "Tuesday, November 18, 2025 • 1:00 PM - 2:00 PM",
                location: "Black Resource Center",
                description:
                  "Healing circle for Black women at the Black Resource Center.",
                action: "Join",
                tag: "Wellness",
                color: "rgba(34, 197, 94, 0.2)",
              },
              {
                name: "Trans4",
                date: "Tuesday, November 18, 2025 • 1:30 PM - 2:30 PM",
                location: "The Pride Center Multipurpose Room",
                description:
                  "Support group for transgender students at the Pride Center.",
                action: "Join",
                tag: "Support",
                color: "rgba(245, 158, 11, 0.2)",
              },
              {
                name: "Getting Unstuck: A C&PS Drop-In Group",
                date: "Tuesday, November 18, 2025 • 3:00 PM - 4:15 PM",
                location: "Calpulli Center Conference Room 4",
                description:
                  "Free drop-in counseling group for students feeling stuck.",
                action: "Join",
                tag: "Counseling",
                color: "rgba(34, 197, 94, 0.2)",
              },
              {
                name: "Gender Journey",
                date: "Tuesday, November 18, 2025 • 3:30 PM - 4:30 PM",
                location: "The Pride Center Multipurpose Room",
                description:
                  "Support group for students exploring gender identity.",
                action: "Join",
                tag: "Support",
                color: "rgba(245, 158, 11, 0.2)",
              },
              {
                name: "Aztec Mens Basketball vs Troy",
                date: "Tuesday, November 18, 2025 • 7:00 PM - 9:30 PM",
                location: "Viejas Arena",
                description:
                  "Aztec Mens Basketball game against Troy. Free with student tickets.",
                action: "Get Tickets",
                tag: "Sports",
              ...
              },
              {
                ...
                date: "Wednesday, November 19, 2025 • 10:00 AM - 2:00 PM",
                location: "Centennial Walkway",
                description:
                  "Learn about global education opportunities and study abroad programs.",
                action: "Join",
                tag: "Education",
                color: "rgba(168, 85, 247, 0.2)",
              },
              ...
              <div key={index} className={`${t.card} rounded-lg p-6 border ${t.border}`}>
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      color: event.tag === "Free Entry" ? "#10B981" : "#A6192E",
                    }}
                  >
                    {event.tag}
                  </span>
                ...
                <button
                  onClick={() =>
                    ...
                    handleEventAction(event.name, event.action)
                  }
                  className="px-4 py-2 text-white rounded-lg text-sm"
                  style={{
                    backgroundColor: registeredEvents[event.name]
                      ? "#666"
                      : "#A6192E",
                    cursor: registeredEvents[event.name]
                      ? "default"
                      : "pointer",
                  }}
            ...
            <div className="flex flex-wrap gap-2 mb-6">
              {[
                ...
                <button
                  ...
                  style={{
                    backgroundColor:
                      clubFilter === filter ? "#A6192E" : "transparent",
                        ...
                        onClick={async () => {
                          ...
                          try {
                            const revRes = await fetch(
                              `http://localhost:8000/sections/${section.section_id}/reviews`
                            );
                            const revData = await revRes.json();
                            setSectionReviews(
                              Array.isArray(revData) ? revData : []
                            );
                            const qRes = await fetch(
                              `http://localhost:8000/sections/${section.section_id}/questions`
                            );
                          ...
                          <div>
                            ...
                            <button
                              onClick={async (e) => {
                                e.stopPropagation();
                                const res = await fetch(
                                  `http://localhost:8000/syllabus/${section.section_id}`
                                );
                                const data = await res.json();
                    ...
                    {selectedProfessor.total_reviews > 0 && (
                      <div className="text-right">
                        <div
                          ...
                          style={{ color: "#A6192E" }}
                        >
                          {selectedProfessor.avg_rating.toFixed(1)}
                        </div>
                        <div className="text-sm text-gray-400">
                          {selectedProfessor.total_reviews} reviews
                        </div>
                      </div>
                    )}
                  </div>
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-4 text-sm">
                      <div>
                        ...
                        <span className="font-bold text-white">
                          {selectedProfessor.avg_difficulty.toFixed(1)}/5.0
                        </span>
                      </div>
                      <div>
                        <span className="text-gray-400">Take Again: </span>
                        <span
                          className="font-bold"
                          style={{ color: "#A6192E" }}
                        >
                          {selectedProfessor.would_take_again_percent.toFixed(
                            0
                          )}
                          %
                        </span>
                  ...
                  <div className="space-y-3">
                    {profCourses.map((c: any) => (
                      <div
                        ...
                        onClick={async () => {
                          const res = await fetch(
                            `http://localhost:8000/courses/${c.course_id}`
                          );
                          const data = await res.json();
                        ...
                        <div
                          ...
                          onClick={async () => {
                            ...
                            if (data.sections.length > 0) {
                              ...
                              const revRes = await fetch(
                                `http://localhost:8000/sections/${data.sections[0].section_id}/reviews`
                              );
                              setSectionReviews(await revRes.json());
                              const qRes = await fetch(
                                `http://localhost:8000/sections/${data.sections[0].section_id}/questions`
                              );
                      ...
                      courseProfessors.map((prof: any) => (
                        <div
                          ...
                          onClick={async () => {
                            ...
                            setSelectedCourse(null);
                            const res = await fetch(
                              `http://localhost:8000/professors/${prof.id}`
                            );
                            const data = await res.json();
                            setProfCourses(
                                ...
                                <div className="flex gap-4 mt-3 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <span
                                      ...
                                      style={{ color: "#A6192E" }}
                                    >
                                      {prof.would_take_again_percent.toFixed(0)}
                                      %
                                    </span>
                                  </div>
                                </div>
                ...
                {showTagSelector && (
                  <div className={`mb-4 p-4 ${t.input} rounded-lg border ${t.border}`}>
                    ...
                    <div className="flex flex-wrap gap-2 max-h-48 overflow-y-auto">
                      {allTags
                        .filter((t) => !userTags.find((ut) => ut.id === t.id))
                        .map((tag) => (
                          <button
                            key={tag.id}
                            onClick={() => handleAddTag(tag.id)}
                            className={`px-3 py-2 text-white text-sm rounded ${getTagColor(
                              tag.name
          ...
          {activeSection === "courses" ? (
            <>
              <div>
                ...
                <div className="space-y-3">
                  {popularProfs.length > 0 ? (
                    popularProfs.slice(0, 5).map((prof: any) => (
                      <div
                        key={prof.id}
                        onClick={async () => {
                          setSelectedProfessor(prof);
            ...
            <div className="p-6">
              <div className="flex justify-between items-start mb-6">
                <div className="flex gap-4">
                  <img
                    src={`https://ui-avatars.com/api/?name=${selectedUser.username}&size=150&background=random&color=fff&bold=true`}
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2 mb-2">
                      {selectedUser.tags?.map((tag: string) => (
                        <span
                          key={tag}
                          className={`px-3 py-1 text-white text-sm rounded ${getTagColor(
                            tag
                          )}`}
                        >
                          {tag}
                      ...
                      {(() => {
                        ...
                        for (let d = 1; d <= daysInMonth; d++) {
                          ...
                          days.push(
                            <div
                              key={d}
                              className={`text-sm py-3 rounded-lg font-medium transition-all cursor-pointer ${
                                isAvailable
